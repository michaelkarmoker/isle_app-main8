                    ...
                    Expanded(
                        child: IndexedStack(
                          ...
                          children: [
                            ...
                            ChildCategoryNewInRightSiteWidget(
...
class ChildCategoryNewInRightSiteWidget extends StatefulWidget {
  final ChildCategoryProductFilterNewIn? newInModel;
  final Function(int) onNewInSelected;

  const ChildCategoryNewInRightSiteWidget({
    super.key,
  ...
  @override
  State<ChildCategoryNewInRightSiteWidget> createState() => _ChildCategoryNewInRightSiteWidgetState();
}

class _ChildCategoryNewInRightSiteWidgetState extends State<ChildCategoryNewInRightSiteWidget> {
  int? selectedNewIn;
