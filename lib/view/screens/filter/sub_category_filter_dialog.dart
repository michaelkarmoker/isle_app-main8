...
class SubCategorySectionRightSiteWidget extends StatefulWidget {
  final List<SubCategoryProductCategories> sections;
  final Function onSectionSelected;

  const SubCategorySectionRightSiteWidget({
    super.key,
  ...
  @override
  State<SubCategorySectionRightSiteWidget> createState() => _SubCategorySectionRightSiteWidgetState();
}

class _SubCategorySectionRightSiteWidgetState extends State<SubCategorySectionRightSiteWidget> {
...
class SubCategorySizeTypesRightSiteWidget extends StatefulWidget {
  final List<SubCategoryProductSizesModel> sizedModel;
  final Function onSizeSelected;


  const SubCategorySizeTypesRightSiteWidget({
    Key? key,
  ...
  @override
  State<SubCategorySizeTypesRightSiteWidget> createState() =>
      _SubCategorySizeTypesRightSiteWidgetState();
}

class _SubCategorySizeTypesRightSiteWidgetState extends State<SubCategorySizeTypesRightSiteWidget> {
...
class SubCategoryBrandRightSiteWidget extends StatefulWidget {
  final List<SubCategoryProductBrands> brandModel;
  final Function onSizeSelected;
  const SubCategoryBrandRightSiteWidget({
    super.key,
  ...
  @override
  State<SubCategoryBrandRightSiteWidget> createState() => _SubCategoryBrandRightSiteWidgetState();
}

class _SubCategoryBrandRightSiteWidgetState extends State<SubCategoryBrandRightSiteWidget> {
...
class SubCategoryColorRightSiteWidget extends StatefulWidget {
  final List<SubCategoryProductColors> colorModel;
  final Function onSizeSelected;

  const SubCategoryColorRightSiteWidget({
    super.key,
  ...
  @override
  State<SubCategoryColorRightSiteWidget> createState() => _SubCategoryColorRightSiteWidgetState();
}

class _SubCategoryColorRightSiteWidgetState extends State<SubCategoryColorRightSiteWidget> {
...
class SubCategoryPriceRightSiteWidget extends StatefulWidget {
  ...
  @override
  State<SubCategoryPriceRightSiteWidget> createState() => _SubCategoryPriceRightSiteWidgetState();
}

class _SubCategoryPriceRightSiteWidgetState extends State<SubCategoryPriceRightSiteWidget> {
...
class SubCategoryNewInRightSiteWidget extends StatefulWidget {
  final SubCategoryProductNewIn? newInModel;
  final Function(int) onNewInSelected;

  const SubCategoryNewInRightSiteWidget({
    super.key,
  ...
  @override
  State<SubCategoryNewInRightSiteWidget> createState() => _SubCategoryNewInRightSiteWidgetState();
}

class _SubCategoryNewInRightSiteWidgetState extends State<SubCategoryNewInRightSiteWidget> {
  int? selectedNewIn;
...
class SubCategoryDiscountRightSiteWidget extends StatefulWidget {
  final SubCategoryProductDiscount? discountModel;
  final Function(int) onDiscountSelected;

  const SubCategoryDiscountRightSiteWidget({
    super.key,
  ...
  @override
  State<SubCategoryDiscountRightSiteWidget> createState() =>
      _SubCategoryDiscountRightSiteWidgetState();
}

class _SubCategoryDiscountRightSiteWidgetState
    extends State<SubCategoryDiscountRightSiteWidget> {
  int? selectedDiscount;
