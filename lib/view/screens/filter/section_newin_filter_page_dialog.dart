                    ...
                    Expanded(
                        child: IndexedStack(
                          ...
                          children: [
                            ...
                            SectionNewInNewInRightSiteWidget(
...
class SectionNewInNewInRightSiteWidget extends StatefulWidget {
  final SectionNewInNewInModel? newInModel;
  final Function(int) onNewInSelected;

  const SectionNewInNewInRightSiteWidget({
    super.key,
  ...
  @override
  State<SectionNewInNewInRightSiteWidget> createState() => _SectionNewInNewInRightSiteWidgetState();
}

class _SectionNewInNewInRightSiteWidgetState extends State<SectionNewInNewInRightSiteWidget> {
  int? selectedNewIn;
