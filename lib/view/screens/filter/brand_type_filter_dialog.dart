                    ...
                    Expanded(
                        child: IndexedStack(
                          ...
                          children: [
                            ...
                            // ),
                            BrandTypeDiscountRightSiteWidget(
                              discountModel: widget.filterModel?.data?.discount,
                              onDiscountSelected: onDiscountSelected,
                            ),
                            BrandTypeNewInRightSiteWidget(
                              newInModel: widget.filterModel?.data?.newIn,
                              onNewInSelected: onNewInSelected,
                            ),
                            BrandTypePriceRightSiteWidget(
...
class BrandTypeSectionRightSiteWidget extends StatefulWidget {
  final List<BrandTypeProductFilterAllBrands> sections;
  final Function onSectionSelected;

  const BrandTypeSectionRightSiteWidget({
    super.key,
  ...
  @override
  State<BrandTypeSectionRightSiteWidget> createState() => _BrandTypeSectionRightSiteWidgetState();
}

class _BrandTypeSectionRightSiteWidgetState extends State<BrandTypeSectionRightSiteWidget> {
...
class BrandTypeSizeTypesRightSiteWidget extends StatefulWidget {
  final List<BrandTypeProductFilterSizes> sizedModel;
  final Function onSizeSelected;


  const BrandTypeSizeTypesRightSiteWidget({
    Key? key,
  ...
  @override
  State<BrandTypeSizeTypesRightSiteWidget> createState() =>
      _BrandTypeSizeTypesRightSiteWidgetState();
}

class _BrandTypeSizeTypesRightSiteWidgetState extends State<BrandTypeSizeTypesRightSiteWidget> {
...
class BrandTypeColorRightSiteWidget extends StatefulWidget {
  final List<BrandTypeProductFilterColors> colorModel;
  final Function onSizeSelected;

  const BrandTypeColorRightSiteWidget({
    super.key,
  ...
  @override
  State<BrandTypeColorRightSiteWidget> createState() => _BrandTypeColorRightSiteWidgetState();
}

class _BrandTypeColorRightSiteWidgetState extends State<BrandTypeColorRightSiteWidget> {
...
class BrandTypePriceRightSiteWidget extends StatefulWidget {
  ...
  @override
  State<BrandTypePriceRightSiteWidget> createState() => _BrandTypePriceRightSiteWidgetState();
}

class _BrandTypePriceRightSiteWidgetState extends State<BrandTypePriceRightSiteWidget> {
...
class BrandTypeNewInRightSiteWidget extends StatefulWidget {
  final BrandTypeNewInDataModel? newInModel;
  final Function(int) onNewInSelected;

  const BrandTypeNewInRightSiteWidget({
    super.key,
  ...
  @override
  State<BrandTypeNewInRightSiteWidget> createState() => _BrandTypeNewInRightSiteWidgetState();
}

class _BrandTypeNewInRightSiteWidgetState extends State<BrandTypeNewInRightSiteWidget> {
  int? selectedNewIn;
...
class BrandTypeDiscountRightSiteWidget extends StatefulWidget {
  final BrandTypeDiscount? discountModel;
  final Function(int) onDiscountSelected;

  const BrandTypeDiscountRightSiteWidget({
    super.key,
  ...
  @override
  State<BrandTypeDiscountRightSiteWidget> createState() =>
      _BrandTypeDiscountRightSiteWidgetState();
}

class _BrandTypeDiscountRightSiteWidgetState
    extends State<BrandTypeDiscountRightSiteWidget> {
  int? selectedDiscount;
