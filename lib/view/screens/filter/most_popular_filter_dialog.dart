                    ...
                    Expanded(
                        child: IndexedStack(
                          ...
                          children: [
                            ...
                            // const SizedBox(height: 30, width: 80),
                            // const SizedBox(height: 30, width: 80),
                            MostPopularNewInRightSiteWidget(
...
class MostPopularNewInRightSiteWidget extends StatefulWidget {
  final MostPopularFilterTermNewInDataModel? newInModel;
  final Function(int) onNewInSelected;

  const MostPopularNewInRightSiteWidget({
    super.key,
  ...
  @override
  State<MostPopularNewInRightSiteWidget> createState() => _MostPopularNewInRightSiteWidgetState();
}

class _MostPopularNewInRightSiteWidgetState extends State<MostPopularNewInRightSiteWidget> {
  int? selectedNewIn;
...
class SectionDiscountRightSiteWidget extends StatefulWidget {
  final MostPopularFilterTermDiscount? discountModel;
