...
class PeopleDiscountRightSiteWidget extends StatefulWidget {
  final MultiSectionDiscount? discountModel;
  final Function(int) onDiscountSelected;

  const PeopleDiscountRightSiteWidget({
    super.key,
  ...
  @override
  State<PeopleDiscountRightSiteWidget> createState() => _PeopleDiscountRightSiteWidgetState();
}

class _PeopleDiscountRightSiteWidgetState extends State<PeopleDiscountRightSiteWidget> {
  int? selectedDiscount;
...
class PeopleNewInRightSiteWidget extends StatefulWidget {
  final MultiSectionNewInDataModel? newInModel;
  final Function(int) onNewInSelected;

  const PeopleNewInRightSiteWidget({
    super.key,
  ...
  @override
  State<PeopleNewInRightSiteWidget> createState() => _PeopleNewInRightSiteWidgetState();
}

class _PeopleNewInRightSiteWidgetState extends State<PeopleNewInRightSiteWidget> {
  int? selectedNewIn;
