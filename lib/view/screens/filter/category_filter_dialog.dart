...
class CategorySectionRightSiteWidget extends StatefulWidget {
  final List<CategoryProductCategories> sections;
  final Function onSectionSelected;

  const CategorySectionRightSiteWidget({
    super.key,
  ...
  @override
  State<CategorySectionRightSiteWidget> createState() => _CategorySectionRightSiteWidgetState();
}

class _CategorySectionRightSiteWidgetState extends State<CategorySectionRightSiteWidget> {
...
class CategorySizeTypesRightSiteWidget extends StatefulWidget {
  final List<CategoryProductSizesModel> sizedModel;
  final Function onSizeSelected;


  const CategorySizeTypesRightSiteWidget({
    Key? key,
  ...
  @override
  State<CategorySizeTypesRightSiteWidget> createState() =>
      _CategorySizeTypesRightSiteWidgetState();
}

class _CategorySizeTypesRightSiteWidgetState extends State<CategorySizeTypesRightSiteWidget> {
...
class CategoryBrandRightSiteWidget extends StatefulWidget {
  final List<CategoryProductBrands> brandModel;
  final Function onSizeSelected;
  const CategoryBrandRightSiteWidget({
    super.key,
  ...
  @override
  State<CategoryBrandRightSiteWidget> createState() => _CategoryBrandRightSiteWidgetState();
}

class _CategoryBrandRightSiteWidgetState extends State<CategoryBrandRightSiteWidget> {
...
class CategoryColorRightSiteWidget extends StatefulWidget {
  final List<CategoryProductColors> colorModel;
  final Function onSizeSelected;

  const CategoryColorRightSiteWidget({
    super.key,
  ...
  @override
  State<CategoryColorRightSiteWidget> createState() => _CategoryColorRightSiteWidgetState();
}

class _CategoryColorRightSiteWidgetState extends State<CategoryColorRightSiteWidget> {
...
class CategoryPriceRightSiteWidget extends StatefulWidget {
  ...
  @override
  State<CategoryPriceRightSiteWidget> createState() => _CategoryPriceRightSiteWidgetState();
}

class _CategoryPriceRightSiteWidgetState extends State<CategoryPriceRightSiteWidget> {
...
class CategoryNewInRightSiteWidget extends StatefulWidget {
  final CategoryProductNewIn? newInModel;
  final Function(int) onNewInSelected;

  const CategoryNewInRightSiteWidget({
    super.key,
  ...
  @override
  State<CategoryNewInRightSiteWidget> createState() => _CategoryNewInRightSiteWidgetState();
}

class _CategoryNewInRightSiteWidgetState extends State<CategoryNewInRightSiteWidget> {
  int? selectedNewIn;
...
class CategoryDiscountRightSiteWidget extends StatefulWidget {
  final CategoryProductDiscount? discountModel;
  final Function(int) onDiscountSelected;

  const CategoryDiscountRightSiteWidget({
    super.key,
  ...
  @override
  State<CategoryDiscountRightSiteWidget> createState() =>
      _CategoryDiscountRightSiteWidgetState();
}

class _CategoryDiscountRightSiteWidgetState
    extends State<CategoryDiscountRightSiteWidget> {
  int? selectedDiscount;
