                    ...
                    Expanded(
                        child: IndexedStack(
                          ...
                          children: [
                            ...
                            SellSectionNewInRightSiteWidget(
...
class SellSectionNewInRightSiteWidget extends StatefulWidget {
  final SellProductFilterTermNewIn? newInModel;
  final Function(int) onNewInSelected;

  const SellSectionNewInRightSiteWidget({
    super.key,
  ...
  @override
  State<SellSectionNewInRightSiteWidget> createState() => _SellSectionNewInRightSiteWidgetState();
}

class _SellSectionNewInRightSiteWidgetState extends State<SellSectionNewInRightSiteWidget> {
  int? selectedNewIn;
