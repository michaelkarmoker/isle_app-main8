...
class DateConverter {
  ...
  static String stringToLocalWeekOnly(String dateTime) {
    return DateFormat('EEE').format(DateFormat('yyyy-MM-dd').parse(dateTime));
  }
  static String stringToWeekDateString(String dateTime) {
    return DateFormat('EEE MMM dd, yyyy').format(DateFormat('yyyy-MM-dd').parse(dateTime));
  }
