  ...
  Future<void> getTotal({required bool isPop, required bool fromCheckout}) async {
    ...
    if (cartPageResponse != null) {
      ...
      cartPageResponse!.data!.forEach((e) async {
        ...
        // if (minimumPurchaseDiscount>0){
        //   print("object");
        //   minimumOrderProductDisc = (minimumPurchaseDiscount / subTotal) * e.product!.discountedPrice!.toDouble();
        // }
    ...
    cartTotal = subTotal-isleCouponDis-brandCouponDis-minimumPurchaseDiscount-redeemPoint-firstOrderDiscount; // Subtract discount from subTotal
