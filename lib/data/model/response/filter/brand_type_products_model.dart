class BrandTypeProductModel {
  int? statusCode;
  String? status;
  String? message;
  BrandTypeProductData? data;

  BrandTypeProductModel(
      {this.statusCode, this.status, this.message, this.data});

  BrandTypeProductModel.fromJson(Map<String, dynamic> json) {
    statusCode = json['statusCode'];
    status = json['status'];
    message = json['message'];
    data = json['data'] != null ? BrandTypeProductData.fromJson(json['data']) : null;
  }
...
class BrandTypeProductData {
  List<BrandTypeProductResult>? result;
  Pagination? pagination;

  BrandTypeProductData({this.result, this.pagination});

  BrandTypeProductData.fromJson(Map<String, dynamic> json) {
    if (json['result'] != null) {
      result = <BrandTypeProductResult>[];
      json['result'].forEach((v) {
        result!.add(BrandTypeProductResult.fromJson(v));
      });
    }
...
class BrandTypeProductResult {
  ...
  BrandTypeProductResult.fromJson(Map<String, dynamic> json) {
    id = json['id'];
