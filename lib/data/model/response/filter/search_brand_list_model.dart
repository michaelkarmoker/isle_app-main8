class SearchBrandListModel {
  int? statusCode;
  String? status;
  String? message;
  List<SearchBrandListData>? data;

  SearchBrandListModel({this.statusCode, this.status, this.message, this.data});

  SearchBrandListModel.fromJson(Map<String, dynamic> json) {
    statusCode = json['statusCode'];
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <SearchBrandListData>[];
      json['data'].forEach((v) {
        data!.add(SearchBrandListData.fromJson(v));
      });
    }
  }
...
class SearchBrandListData {
  ...
  SearchBrandListData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    slug = json['slug'];
