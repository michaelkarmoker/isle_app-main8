class BrandProductListModel {
  ...
  String? status;
  String? message;
  BrandProductListData? data;

  BrandProductListModel(
      {this.statusCode, this.status, this.message, this.data});

  BrandProductListModel.fromJson(Map<String, dynamic> json) {
    statusCode = json['statusCode'];
    status = json['status'];
    message = json['message'];
    data = json['data'] != null ? new BrandProductListData.fromJson(json['data']) : null;
  }
...
class BrandProductListData {
  List<BrandProductListResult>? result;
  Pagination? pagination;

  BrandProductListData({this.result, this.pagination});

  BrandProductListData.fromJson(Map<String, dynamic> json) {
    if (json['result'] != null) {
      result = <BrandProductListResult>[];
      json['result'].forEach((v) {
        result!.add(new BrandProductListResult.fromJson(v));
      });
    }
...
class BrandProductListResult {
  ...
  BrandProductListResult.fromJson(Map<String, dynamic> json) {
    id = json['id'];
