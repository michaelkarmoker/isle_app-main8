class SearchPoductListModel {
  int? statusCode;
  String? status;
  String? message;
  SearchPoductListData? data;

  SearchPoductListModel(
      {this.statusCode, this.status, this.message, this.data});

  SearchPoductListModel.fromJson(Map<String, dynamic> json) {
    statusCode = json['statusCode'];
    status = json['status'];
    message = json['message'];
    data = json['data'] != null ? SearchPoductListData.fromJson(json['data']) : null;
  }
...
class SearchPoductListData {
  List<SearchPoductListResult>? result;
  Pagination? pagination;

  SearchPoductListData({this.result, this.pagination});

  SearchPoductListData.fromJson(Map<String, dynamic> json) {
    if (json['result'] != null) {
      result = <SearchPoductListResult>[];
      json['result'].forEach((v) {
        result!.add(SearchPoductListResult.fromJson(v));
      });
    }
...
class SearchPoductListResult {
  ...
  SearchPoductListResult.fromJson(Map<String, dynamic> json) {
    id = json['id'];
