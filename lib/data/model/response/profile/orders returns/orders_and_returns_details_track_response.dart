...
/// customer : {"id":31,"membership_tier_id":2,"point":30,"use_point":0,"membership_tier":{"id":2,"tiers_name":"EXPLORER","is_default":true,"upgrade_point":50000,"upgrade_amount":0,"upgrade_time_limit":365,"short_description":"EXPLORER is the first tier of ISLE Rewards programme, bringing you incredible rewards & bonuses at any purchase","color_code":"#9b908c","image":"/public/uploads/isle-reward-point-stickers-v2-04-MqV2IfgVE.png","created_at":"2023-12-30T06:25:48.000Z","updated_at":"2024-02-07T10:17:46.000Z"}}
...
/// point : 30
/// use_point : 0
/// membership_tier : {"id":2,"tiers_name":"EXPLORER","is_default":true,"upgrade_point":50000,"upgrade_amount":0,"upgrade_time_limit":365,"short_description":"EXPLORER is the first tier of ISLE Rewards programme, bringing you incredible rewards & bonuses at any purchase","color_code":"#9b908c","image":"/public/uploads/isle-reward-point-stickers-v2-04-MqV2IfgVE.png","created_at":"2023-12-30T06:25:48.000Z","updated_at":"2024-02-07T10:17:46.000Z"}
...
class Customer {
  ...
  Customer.fromJson(dynamic json) {
    ...
    membershipTier = json['membership_tier'] != null ? MembershipTier.fromJson(json['membership_tier']) : null;
  }
  num? id;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (membershipTier != null) {
      map['membership_tier'] = membershipTier?.toJson();
    }
    return map;
  }
...
class MembershipTier {
  ...
  MembershipTier.fromJson(dynamic json) {
    id = json['id'];
