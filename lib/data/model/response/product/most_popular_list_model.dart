class MostPopularListModel {
  ...
  String? status;
  String? message;
  MostPopularListData? data;

  MostPopularListModel({this.statusCode, this.status, this.message, this.data});

  MostPopularListModel.fromJson(Map<String, dynamic> json) {
    statusCode = json['statusCode'];
    status = json['status'];
    message = json['message'];
    data = json['data'] != null ? MostPopularListData.fromJson(json['data']) : null;
  }
...
class MostPopularListData {
  List<MostPopularListResult>? result;
  Pagination? pagination;

  MostPopularListData({this.result, this.pagination});

  MostPopularListData.fromJson(Map<String, dynamic> json) {
    if (json['result'] != null) {
      result = <MostPopularListResult>[];
      json['result'].forEach((v) {
        result!.add(MostPopularListResult.fromJson(v));
      });
    }
...
class MostPopularListResult {
  ...
  MostPopularListResult.fromJson(Map<String, dynamic> json) {
    id = json['id'];
