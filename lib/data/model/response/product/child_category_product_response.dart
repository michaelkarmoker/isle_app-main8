class ChildCategoryProductModel {
  int? statusCode;
  String? status;
  String? message;
  ChildCategoryProductData? data;

  ChildCategoryProductModel(
      {this.statusCode, this.status, this.message, this.data});

  ChildCategoryProductModel.fromJson(Map<String, dynamic> json) {
    statusCode = json['statusCode'];
    status = json['status'];
    message = json['message'];
    data = json['data'] != null ? ChildCategoryProductData.fromJson(json['data']) : null;
  }
...
class ChildCategoryProductData {
  List<ChildCategoryProductResult>? result;
  Pagination? pagination;

  ChildCategoryProductData({this.result, this.pagination});

  ChildCategoryProductData.fromJson(Map<String, dynamic> json) {
    if (json['result'] != null) {
      result = <ChildCategoryProductResult>[];
      json['result'].forEach((v) {
        result!.add(ChildCategoryProductResult.fromJson(v));
      });
    }
...
class ChildCategoryProductResult {
  int? id;
  int? vendorId;
  int? brandId;
  int? seasonId;
  ...
  ChildCategoryProductResult.fromJson(Map<String, dynamic> json) {
    id = json['id'];
