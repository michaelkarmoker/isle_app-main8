class ShopByOccassionDetailsResponse {
  int? statusCode;
  String? status;
  String? message;
  Data? data;

  ShopByOccassionDetailsResponse(
      {this.statusCode, this.status, this.message, this.data});

  ShopByOccassionDetailsResponse.fromJson(Map<String, dynamic> json) {
...
class Sections {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['assign_day'] = this.assignDay;
    data['assign_brand_id'] = this.assignBrandId;
    data['assign_category_id'] = this.assignCategoryId;
    data['assign_sub_category_id'] = this.assignSubCategoryId;
    data['assign_child_category_id'] = this.assignChildCategoryId;
    data['assign_season_id'] = this.assignSeasonId;
    data['assign_size_id'] = this.assignSizeId;
    data['assign_discount_type'] = this.assignDiscountType;
    data['assign_discount'] = this.assignDiscount;
    data['title'] = this.title;
    data['slug'] = this.slug;
