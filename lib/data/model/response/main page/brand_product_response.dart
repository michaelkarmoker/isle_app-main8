class BrandProductResponse {
  int? statusCode;
  String? status;
  String? message;
  Data? data;

  BrandProductResponse({this.statusCode, this.status, this.message, this.data});

  BrandProductResponse.fromJson(Map<String, dynamic> json) {
