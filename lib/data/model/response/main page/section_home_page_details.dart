class PeopleHomePageModel {
  int? statusCode;
  String? status;
  String? message;
  PeopleHomePageData? data;

  PeopleHomePageModel({this.statusCode, this.status, this.message, this.data});

  PeopleHomePageModel.fromJson(Map<String, dynamic> json) {
    statusCode = json['statusCode'];
    status = json['status'];
    message = json['message'];
    data = json['data'] != null ? PeopleHomePageData.fromJson(json['data']) : null;
  }
...
class PeopleHomePageData {
  List<PeopleResult>? result;
  Pagination? pagination;

  PeopleHomePageData({this.result, this.pagination});

  PeopleHomePageData.fromJson(Map<String, dynamic> json) {
    if (json['result'] != null) {
      result = <PeopleResult>[];
      json['result'].forEach((v) {
        result!.add(PeopleResult.fromJson(v));
      });
    }
...
class Pages {
  ...
  Pages({this.id, this.title, this.pageTitle, this.pageProduct});
