class YouMayAlsoLikeModel {
  ...
  YouMayAlsoLikeModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <YouMayAlsoLikeData>[];
      json['data'].forEach((v) {
        data!.add(new YouMayAlsoLikeData.fromJson(v));
      });
    }
  }
...
class YouMayAlsoLikeData {
  ...
  YouMayAlsoLikeData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
