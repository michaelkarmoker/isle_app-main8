...
import 'package:isletestapp/data/model/response/error_response.dart';
...
class ApiClient extends GetConnect implements GetxService {
  ...
  void updateHeader(String? token) {
    if (token != null) {
      //String modifiedToken = token.startsWith('Bearer ') ? token.substring(7) : token;
      _mainHeaders = {
        'Content-Type': 'application/json; charset=UTF-8',
        'Authorization': token,
      };
      // print('Token updated: modifiedToken);
    } else {
  ...
  Future<Response> getData(String uri, {Map<String, dynamic>? query, String? contentType,
    ...
    try {
      ...
      log('Get Response: $uri ', error: e, stackTrace: s);
